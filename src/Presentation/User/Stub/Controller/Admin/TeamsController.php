...
use WeProDev\LaraPanel\Presentation\User\Controller\Admin\TeamsController as AdminTeamsController;

final class TeamsController extends AdminTeamsController
{
    /*
    |--------------------------------------------------------------------------
